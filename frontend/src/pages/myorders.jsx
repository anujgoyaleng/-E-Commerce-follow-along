import { useState, useEffect } from 'react';
   ...
   const MyOrdersPage = () => {
       ...
       const defaultEmail = 'Panda@gmail.com';
       ...
       const fetchOrders = async () => {
           try {
               setLoading(true);
               setError('');
               const response = await axios.get('http://localhost:5050/api/v2/orders/myorders', {
       ...
       const cancelOrder = async (orderId) => {
           console.log("aa")
           try {
               const response = await axios.patch(`http://localhost:5050/api/v2/orders/cancel-order/${orderId}`);
